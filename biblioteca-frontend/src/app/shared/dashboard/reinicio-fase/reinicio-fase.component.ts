...
@Component({
  selector: 'app-reinicio-fase',
  templateUrl: './reinicio-fase.component.html',
  styleUrls: ['./reinicio-fase.component.scss'],
})
export class ReinicioFaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.metricasService.reinicioDeJogo(params).subscribe((metricas: any[]) => {
      metricas.forEach(m => {
