...
@Component({
  selector: 'app-erro-de-compilacao',
  templateUrl: './erro-de-compilacao.component.html',
  styleUrls: ['./erro-de-compilacao.component.scss'],
})
export class ErroDeCompilacaoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.metricasService.erroDeCompilacao(params).subscribe((metricas: any[]) => {
      metricas.forEach(m => {
