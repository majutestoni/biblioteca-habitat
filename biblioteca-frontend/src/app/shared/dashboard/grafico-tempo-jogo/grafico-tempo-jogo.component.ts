...
@Component({
  selector: 'app-grafico-tempo-jogo',
  templateUrl: './grafico-tempo-jogo.component.html',
  styleUrls: ['./grafico-tempo-jogo.component.scss'],
})
export class GraficoTempoJogoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.isLoading = true;
    this.metricasService.tempoDeJogo(params).subscribe((metricas: any[]) => {
      metricas.forEach(m => {
