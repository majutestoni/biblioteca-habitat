...
@Component({
  selector: 'app-erro-de-execucao',
  templateUrl: './erro-de-execucao.component.html',
  styleUrls: ['./erro-de-execucao.component.scss'],
})
export class ErroDeExecucaoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.metricasService.erroDeExecucao(params).subscribe((metricas: any[]) => {
      metricas.forEach(m => {
